...
This workspace uses `sl-tool` + `sl-test-example` to validate all examples under `examples/scripts-rhai`.

## Layout
- Case file path: `examples/scripts-rhai/<example>/testcase.json`
